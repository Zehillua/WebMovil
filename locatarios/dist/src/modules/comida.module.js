...
exports.ComidaModule = ComidaModule = __decorate([
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([{ name: comida_schema_1.Comida.name, schema: comida_schema_1.ComidaSchema }]),
        ],
        controllers: [comidas_controller_1.ComidaController],
        providers: [comida_service_1.ComidaService],
        exports: [comida_service_1.ComidaService],
    })
], ComidaModule);
